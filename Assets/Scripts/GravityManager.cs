...
public class GravityManager : MonoBehaviour
{
    ...
    static private double GRAVITY = 6.6743 * 1 / 1000.0; // that's e-3, can't seem to type it directly as scientific notation, also, G is supposed to be e-11 but Unity's masses are floats, not doubles so they can't go above 1e9 which means keeping G at e-11 means nothing's moving ever
